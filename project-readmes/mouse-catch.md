...
Everything you need to build and deploy your Mouse Catch app.
...
| Start a new project | Duplicate folder, rewrite `PROJECT.md`, run `zsh bin/setup.sh` |
...
Move the `mouse-catch` folder to your Documents folder. You should end up with:

```
~/Documents/mouse-catch/
```
...
1. Right-click any `.md` file in Finder (for example, this `README.md`)
2. Choose **Get Info**
...
1. Duplicate the `mouse-catch` folder in Finder and rename it (e.g. `chess-game`)
2. Open `PROJECT.md` in the new folder and rewrite it to describe your new app — use the current version as a guide for what to include
